...
<link href="1SpryAssets/SpryValidationSelect.css" rel="stylesheet" type="text/css" />
<link href="1SpryAssets/SpryValidationTextField.css" rel="stylesheet" type="text/css" />
<script src="1SpryAssets/SpryValidationSelect.js" type="text/javascript"></script>
<script src="1SpryAssets/SpryValidationTextField.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div id="content_wrapper">
        ...
        <div id="content_left">
        	...
        	<div class="content_box">
				<h2>Welcome Admin</h2>
                                <p align="RIGHT"><a href="viewuser.php">VIEW ALL DEPARTMENT USERS</a></p>
	            <form action="adduser.php" method="post" name="form1" id="form1">
	              <table width="600" border="0" align="center" cellspacing="0">
                    ...
                    <tr>
	                  ...
	                  <th width="272" align="left"> <div align="left">
                      ...
                      Please select an item.</span></span></div></th>
	                ...
	                <tr>
	                  ...
	                  <th width="272" align="left"> <div align="left">
	                    <label for="catname"></label>
                            <input type="text" name="std" id="std" size="4" value="0471" readonly/> - - <span id="sprytextfield2">
                            <input size="7"  type="text" name="phone" id="phone" />
                            <br />
                            <span class="textfieldRequiredMsg"><br />
A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span><span class="textfieldMinCharsMsg">Minimum number of characters not met.</span></span> </div></th>
	                  <th width="40" align="left"></th>
                    </tr>
                           <tr>
	                  <th width="187" height="37" align="left"> <div align="left">Login id</div></th>
	                  <th width="272" align="left"> <div align="left">
	                    <label for="catname"></label>
	                  ...
	                  <th width="40" align="left">&nbsp;</th>
                           ...
                           <tr>
	                  <th width="187" height="37" align="left"> <div align="left">Login Password</div></th>
	                  <th width="272" align="left"> <div align="left">
	                    <label for="catname"></label>
	                    ...
	                    <span class="textfieldRequiredMsg"><br />
	                    A value is required.</span></span></div></th>
	                  <th width="40" align="left"><input type="submit" name="button" id="button" value="ADD" /></th>
                    </tr>
                  </table>
	              <p>&nbsp;</p>
              </form>
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "integer", {minChars:5});
