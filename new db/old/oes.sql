...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2015 at 10:44 PM
...
--
ALTER TABLE `report`
MODIFY `case_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
MODIFY `did` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
