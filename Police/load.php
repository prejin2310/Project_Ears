...
<th align="left" width="24%"> <div>PLACE</div></th>
            ...
            $a="select * from report where `location`='".$row['location']."' and `police` > '0'  ORDER BY `case_id` DESC";
			...
			if($abc['ambu']=="0")
                        ...
                        elseif($abc['police']=="1")
                        {
                           $sta2="<a href=\"update.php?id=".$abc['0']."\"><img width=25 height=25 src=life.png></a>";
                        }
                         elseif($abc['police']==$did)
                        {
                            $sta2="<img width=25 height=25 src=life1.png>";
                        }
                        else
                        {
