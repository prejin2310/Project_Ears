    ...
    <div id="templatemo_menu">
   	  <?php
				session_start();
                                include('link.php');
				include('menu.php');
                                $sql="select * from users where `did`='".$_GET['id']."'";
        	...
        	<div class="content_box">
				<h2>Welcome Admin</h2>
	              ...
	              <table width="505" border="0" align="center" cellspacing="0">
                    ...
                    <tr>
	                  <th width="187" height="38" align="left"> <div align="left">Specific Name</div></th>
	                ...
	                <tr>
	                  <th width="187" height="64" align="left"> <div align="left">Contact Number</div></th>
	                  <th width="221" align="left"> <div align="left">
	                    <label for="catname"></label>
                       <?php echo $row[2]; ?>
	                    </div></th>
	                  ...
	                  <tr>
	                  <th width="187" height="37" align="left"> <div align="left">Department</div></th>
	                  <th width="221" align="left"> <div align="left">
	                    <label for="catname"></label>
	                     <?php echo $row[4]; ?>
	                  </div></th>
