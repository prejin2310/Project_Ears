...
<th align="left" width="24%"> <div>PLACE</div></th>
            ...
            $a="select * from report where `location`='".$row['location']."' and `hospital` > '0'  ORDER BY `case_id` DESC";
			...
			if($abc['ambu']=="0")
                        ...
                        {
                            $sta4="<a href=\"update.php?id=".$abc['0']."\"><img width=25 height=25 src=life.png></a>";
                        }
                         elseif($abc['hospital']==$did)
                        {
                            $sta4="<img width=25 height=25 src=life1.png>";
                        }
                        else
                        {
